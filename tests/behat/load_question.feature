...
Feature: Test the clozergx question editor string parser that a selected question string loads correctly into the dialogue.
  ...
  Scenario: Load MC question string with feedback
    ...
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[1]//input[contains(@class, 'tiny_clozergx_answer')]" matches value "California"
    ...
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[1]//input[contains(@class, 'tiny_clozergx_feedback')]" matches value "OK"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[2]//input[contains(@class, 'tiny_clozergx_answer')]" matches value "Arizona"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[2]//select[contains(@class, 'tiny_clozergx_frac')]" matches value "Incorrect"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[2]//input[contains(@class, 'tiny_clozergx_feedback')]" matches value "Wrong"
  ...
  Scenario: Load MULTIRESPONSE question with custom percentages
    ...
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[1]//input[contains(@class, 'tiny_clozergx_answer')]" matches value "cat"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[1]//select[contains(@class, 'tiny_clozergx_frac')]" matches value "0"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[2]//input[contains(@class, 'tiny_clozergx_answer')]" matches value "dog"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[2]//select[contains(@class, 'tiny_clozergx_frac')]" matches value "Custom"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[2]//input[contains(@class, 'tiny_clozergx_frac_custom')]" matches value "-22"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[3]//input[contains(@class, 'tiny_clozergx_answer')]" matches value "mouse"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[3]//select[contains(@class, 'tiny_clozergx_frac')]" matches value "100"
  ...
  Scenario: Load SHORTANSWER question with two correct answers
    ...
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[1]//input[contains(@class, 'tiny_clozergx_answer')]" matches value "William"
    And the field with xpath "//form[@name='tiny_clozergx_form']//li[1]//select[contains(@class, 'tiny_clozergx_frac')]" matches value "Correct"
