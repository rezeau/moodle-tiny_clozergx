...
/**
 * Commands helper for the Moodle tiny_clozergx plugin.
 *
 * @module      tiny_clozergx/commands
...
export const getSetup = async() => {
    ...
    return (editor) => {
        ...
        const body = document.querySelector('body#page-question-type-multianswerrgx form, ' +
